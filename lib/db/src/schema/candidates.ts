...
export const candidatesTable = pgTable("candidates", {
  ...
  co2AvoidedPerTonne: real("co2_avoided_per_tonne"),
  sdgTags: text("sdg_tags"),
  climateNarrative: text("climate_narrative"),
  toxicityScore: real("toxicity_score"),
  toxicityLevel: text("toxicity_level"),
  toxicityNotes: text("toxicity_notes"),
  toxicitySource: text("toxicity_source"),
  recyclingRetention: text("recycling_retention"),
  reactorType: text("reactor_type"),
  reactorVolumeMin: real("reactor_volume_min"),
  reactorVolumeMax: real("reactor_volume_max"),
  reactorConstraints: text("reactor_constraints"),
